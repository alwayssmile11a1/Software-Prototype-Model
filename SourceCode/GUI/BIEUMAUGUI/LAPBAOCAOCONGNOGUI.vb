Imports DTO
Imports BUS
Public Class LAPBAOCAOCONGNOGUI

    Public Shared GUI As New LAPBAOCAOCONGNOGUI
    ...
    Private Sub LapBaoCaoButton_Click(sender As Object, e As EventArgs) Handles LapBaoCaoButton.Click
        ...
        'Get DataTable
        Dim dataTable As DataTable = CHITIETCONGNOBUS.SearchAllUnRemovedChiTietCongNos(ThangLapBaoCaoDateTimePicker.Value.Month, ThangLapBaoCaoDateTimePicker.Value.Year, ex)
    ...
    Private Sub backgroundWorker_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker.DoWork
        ...
        Try
            ...
            For iColumn As Integer = 1 To LapBaoCaoCongNoGridView.Columns.Count
                worksheet.Cells(1, iColumn) = LapBaoCaoCongNoGridView.Columns(iColumn - 1).FieldName
            ...
            For iRow As Integer = 0 To LapBaoCaoCongNoGridView.RowCount - 1
                'get current row
                Dim selectedRow As DataRow = LapBaoCaoCongNoGridView.GetDataRow(LapBaoCaoCongNoGridView.GetRowHandle(iRow))
